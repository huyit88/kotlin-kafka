...
// The plugin automatically generates classes to build/generated-main-avro-java
// and includes them in the source set
configure<com.github.davidmc24.gradle.plugin.avro.DefaultAvroExtension> {
