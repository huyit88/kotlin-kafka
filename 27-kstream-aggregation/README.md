# Challenge 27: kstream-aggregations
...
### Run the Application
```bash
./gradlew :27-kstream-aggregations:run
```

### Test the Application
```bash
# Run all tests
./gradlew :27-kstream-aggregations:test

# Build the project
./gradlew :27-kstream-aggregations:build
```
