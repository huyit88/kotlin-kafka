# Challenge 14: spring-kafka-producer
...
### Run the Application
```bash
./gradlew :14-spring-kafka-producer:run
```

### Test the Application
```bash
# Run all tests
./gradlew :14-spring-kafka-producer:test

# Build the project
./gradlew :14-spring-kafka-producer:build
```
