# Challenge 15: spring-kafka-listener-consumer
...
### Project Structure
```
15-spring-kafka-listener-consumer/
├── src/
│   ├── main/
...
### Run the Application
```bash
./gradlew :15-spring-kafka-listener-consumer:run
```

### Test the Application
```bash
# Run all tests
./gradlew :15-spring-kafka-listener-consumer:test

# Build the project
./gradlew :15-spring-kafka-listener-consumer:build
```
