# Challenge 26: kstream-stateless-ops
...
### Run the Application
```bash
./gradlew :26-kstream-stateless-ops:run
```

### Test the Application
```bash
# Run all tests
./gradlew :26-kstream-stateless-ops:test

# Build the project
./gradlew :26-kstream-stateless-ops:build
```
