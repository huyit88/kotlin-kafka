# Challenge 36: eos-vs-performance
...
### Run the Application
```bash
./gradlew :36-eos-vs-performance:run
```

### Test the Application
```bash
# Run all tests
./gradlew :36-eos-vs-performance:test

# Build the project
./gradlew :36-eos-vs-performance:build
```
