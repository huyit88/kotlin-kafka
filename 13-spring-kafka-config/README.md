# Challenge 13: spring-kafka-config
...
### Run the Application
```bash
./gradlew :13-spring-kafka-config:run
```

### Test the Application
```bash
# Run all tests
./gradlew :13-spring-kafka-config:test

# Build the project
./gradlew :13-spring-kafka-config:build
```
