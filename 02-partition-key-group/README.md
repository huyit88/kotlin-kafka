# Challenge 03: parition-key-group
...
### Run the Application
```bash
./gradlew :03-parition-key-group:run
```

### Test the Application
```bash
# Run all tests
./gradlew :03-parition-key-group:test

# Build the project
./gradlew :03-parition-key-group:build
```
